...
class TeamRequest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('university_id')) {
                obj['university_id'] = ApiClient.convertToType(data['university_id'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['university_id'] && !(typeof data['university_id'] === 'string' || data['university_id'] instanceof String)) {
            throw new Error("Expected the field `university_id` to be a primitive type in the JSON string but got " + data['university_id']);
        }
        // ensure the json data is a string
